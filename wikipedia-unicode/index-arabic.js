...
const glyphSelectors = [
  'table.wikitable:nth-of-type(1) tr td:nth-child(2)',
  'table.wikitable:nth-of-type(2) tr td:nth-child(2)'
]
...
for (const glyphSelector of glyphSelectors) {
  ...
  for (const cell of glyphCells) {
    ...
    } else if (cell.children[2] && cell.children[2].tagName === 'SPAN') {
      span.textContent = cell.children[2].textContent
    } else {
